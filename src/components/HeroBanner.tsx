    ...
    <section className="noise-overlay relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
        <div className="relative z-10 flex flex-col justify-center">
          <div className="mb-6 inline-flex w-fit items-center gap-3 rounded-full border border-amber-300/20 bg-amber-300/10 px-4 py-2 text-sm font-semibold text-amber-100">
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <Link
              to="/products"
              className="rounded-full bg-gradient-to-r from-amber-500 to-lime-500 px-8 py-4 text-center font-bold text-black transition hover:scale-[1.03] hover:shadow-xl hover:shadow-amber-500/25"
            >
              Shop Products
            </Link>
            <Link
              to="/new-arrivals"
              className="rounded-full border border-white/15 px-8 py-4 text-center font-bold text-white transition hover:border-amber-300 hover:bg-white/10"
            >
              View New Arrivals
            </Link>
          </div>
        ...
        <div className="relative z-10">
          <div className="premium-card glow-ring relative mx-auto max-w-lg rounded-[3rem] p-5">
            <div className="absolute -right-6 top-10 rounded-full border border-amber-300/30 bg-amber-500/20 px-4 py-2 text-sm font-bold text-amber-100 backdrop-blur">
              Save on bundles
            </div>
            <img
            ...
            <div className="mt-5 rounded-[2rem] border border-white/10 bg-black/45 p-5">
              ...
              <div className="mt-3 flex items-end justify-between gap-5">
                ...
                <Link
                  ...
                  className="shrink-0 rounded-full bg-white px-4 py-2 text-sm font-bold text-black transition hover:bg-amber-200"
                >
                  Details
                </Link>
              </div>
