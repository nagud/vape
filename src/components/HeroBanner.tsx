      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
        <div className="relative z-10 flex flex-col justify-center">
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <Link
              to="/products"
              className="rounded-full bg-gradient-to-r from-cyan-500 to-violet-600 px-8 py-4 text-center font-bold text-white transition hover:scale-[1.03] hover:shadow-xl hover:shadow-cyan-500/25"
            >
              Shop Products
            </Link>
            <Link
        ...
        <div className="relative z-10">
          <div className="premium-card glow-ring relative mx-auto max-w-lg rounded-[3rem] p-5">
            <div className="absolute -right-6 top-10 rounded-full border border-cyan-300/30 bg-cyan-500/20 px-4 py-2 text-sm font-bold text-cyan-100 backdrop-blur">
              Save on bundles
            </div>
            <img
